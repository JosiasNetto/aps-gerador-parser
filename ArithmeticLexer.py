...
def serializedATN():
    return [
        ...
        4,4,4,31,8,4,11,4,12,4,32,1,5,4,5,36,8,5,11,5,12,5,37,1,6,1,6,1,
        ...
        7,27,1,0,0,0,9,30,1,0,0,0,11,35,1,0,0,0,13,39,1,0,0,0,15,41,1,0,
        ...
        0,0,32,33,1,0,0,0,33,10,1,0,0,0,34,36,7,1,0,0,35,34,1,0,0,0,36,37,
        1,0,0,0,37,35,1,0,0,0,37,38,1,0,0,0,38,12,1,0,0,0,39,40,5,61,0,0,
        40,14,1,0,0,0,41,42,5,40,0,0,42,16,1,0,0,0,43,44,5,41,0,0,44,18,
        1,0,0,0,45,47,7,2,0,0,46,45,1,0,0,0,47,48,1,0,0,0,48,46,1,0,0,0,
        48,49,1,0,0,0,49,50,1,0,0,0,50,51,6,9,0,0,51,20,1,0,0,0,4,0,32,37,
        48,1,6,0,0
    ]
...
class ArithmeticLexer(Lexer):
    ...
    symbolicNames = [ "<INVALID>",
            "PLUS", "MINUS", "MUL", "DIV", "INT", "VAR", "ASSIGN", "LPAREN", 
            "RPAREN", "WS" ]

    ruleNames = [ "PLUS", "MINUS", "MUL", "DIV", "INT", "VAR", "ASSIGN", 
                  "LPAREN", "RPAREN", "WS" ]
